...
class ConstructionOperations(models.Model):
    construction_operation_id = models.AutoField(primary_key=True)
...
class ConstructionSite(models.Model):
    construction_site_id = models.AutoField(primary_key=True)
...
class Tasks(models.Model):
    task = models.OneToOneField(ConstructionOperations, models.DO_NOTHING, primary_key=True)
    ...
    construction_site = models.ForeignKey(ConstructionSite, models.DO_NOTHING, blank=True, null=True)
    cabin_number = models.ForeignKey(Cabinets, models.DO_NOTHING, db_column='cabin_number', blank=True, null=True)
